...
{{--                    tot hier--}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="prijs-per-dag" type="text" class="form-control @error('prijs_per_dag') is-invalid @enderror" name="prijs_per_dag" value="{{ old('prijs_per_dag') }}" required autocomplete="prijs-per-dag" autofocus>
